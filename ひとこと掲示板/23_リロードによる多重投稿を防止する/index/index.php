...
if( $mysqli->connect_errno ) {
    ...
    $sql = "SELECT id, view_name,message,post_date FROM message ORDER BY now_date DESC";
	$res = $mysqli->query($sql);
...
<?php if( empty($_POST['btn_submit']) && !empty($_SESSION['success_message']) ): ?>
    <p class="success_message"><?php $_SESSION['success_message']; ?></p>
...
<form method="post">
    ...
    !empty($_SESSION['view_name']) ){ echo $_SESSION['view_name']; } ?>">
	</div>
	<div>
